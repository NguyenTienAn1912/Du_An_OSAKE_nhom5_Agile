...
public class MainNhanVien extends javax.swing.JFrame {
    ...
    public MainNhanVien() throws SQLException, ParseException {
        initComponents();
        setLocationRelativeTo(null);
        setBackground(new Color(0, 0, 0, 0));
        menuNhanVien1.initMoving(MainNhanVien.this);
        ...
        menuNhanVien1.addEventMenuSelected(new EventMenuSelected() {
            @Override
    ...
    private void initComponents() {
        ...
        paneBorder2Layout.setHorizontalGroup(
            ...
            .addGroup(paneBorder2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(menuNhanVien1, javax.swing.GroupLayout.PREFERRED_SIZE, 270, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(MainNhanVien.class.getName()).log(Level.SEVERE, null, ex);
